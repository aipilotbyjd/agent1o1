...
import { useCreditBalance, useCreditPacks, useCreditTransactions } from '../_shared/billing.helper';
import { useBillingPortal, useBuyCredits, usePackCatalog } from '../_shared/billing.helper';
import { useSubscription } from '../_shared/billing.helper';
import pages from '@/Routes/pages';
import type { TCreditPack } from '../_shared/billing.types';
						...
						{allPacks.map((pack, i) => {
							...
							return (
								<div
									...
									{/* Top-up credits pool at the workspace level, so the
									    API reports no per-pack remaining balance or expiry. */}
									<p className='text-xs text-zinc-400'>
										{new Date(
											pack.purchased_at ?? pack.created_at,

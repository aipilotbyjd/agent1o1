...
import { useCreditBalance, useCreditPacks } from '../_shared/billing.helper';
import { useBuyCredits, usePackCatalog } from '../_shared/billing.helper';
						...
						<table className='w-full'>
							<thead>
								<tr className='text-left text-xs font-black text-zinc-400 dark:text-zinc-500'>
									...
									<th className='py-3 pr-4 font-black'>Credits</th>
								...
								{activePacks.map((pack) => {
									...
									return (
										<tr
											...
											{/* Top-up credits pool at the workspace level — the
											    API tracks no per-pack remaining balance or expiry. */}
											<td className='py-3 pr-4 text-xs font-bold text-zinc-700 dark:text-zinc-300'>

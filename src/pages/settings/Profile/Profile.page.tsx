					...
					<div className='flex flex-wrap items-center justify-between gap-6'>
						<div className='flex items-center gap-5'>
							...
							<div className='relative'>
								<div className='bg-primary-100 text-primary-800 dark:bg-primary-400/15 dark:text-primary-300 flex h-20 w-20 items-center justify-center rounded-[22px] text-3xl font-black'>
									{getInitials(displayName)}
								</div>
								<button
									type='button'
									onClick={() => fileInputRef.current?.click()}
									className='bg-primary-400 text-primary-950 hover:bg-primary-500 absolute -right-1 -bottom-1 flex h-6.5 w-6.5 items-center justify-center rounded-lg shadow-md transition active:scale-95'
									title='Change photo'>
									<Camera size={13} />
								</button>
							</div>

...
import { useSwitchWorkspace } from '@/api/modules/user';
...
const CreateWorkspacePage = () => {
	...
	return (
		<main className='from-primary-50/80 relative flex min-h-screen flex-col items-center justify-center overflow-x-hidden bg-gradient-to-br via-slate-50/90 to-rose-50/80 p-6 text-slate-950 transition-colors duration-300 md:p-12 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 dark:text-zinc-500'>
			...
			<div className='pointer-events-none absolute inset-0 z-0 overflow-hidden'>
				...
				<div
					className='bg-primary-400/30 dark:bg-primary-900/15 absolute -top-40 -left-40 h-[600px] w-[600px] animate-pulse rounded-full blur-[120px]'
			...
			<header className='absolute top-0 right-0 left-0 z-25 w-full px-8 py-6'>
				<div className='mx-auto flex max-w-7xl items-center justify-between'>
					<div className='flex items-center gap-3'>
						<div className='from-primary-400 to-primary-400 text-primary-950 shadow-primary-500/25 flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-tr shadow-lg'>
			...
			<motion.div
				...
				className='from-primary-400/10 to-primary-400/10 pointer-events-none absolute top-[-15%] left-[-15%] -z-10 h-[60%] w-[60%] rounded-full bg-gradient-to-tr blur-[130px]'
			/>
			<motion.div
				animate={{
					x: [0, -40, 40, 0],
			...
			<motion.div
				...
				className='from-primary-400/8 to-primary-400/8 pointer-events-none absolute top-[30%] right-[5%] -z-10 h-[45%] w-[45%] rounded-full bg-gradient-to-l blur-[110px]'
			/>
			...
			<section className='relative z-10 mx-auto mt-16 grid w-full max-w-[1140px] items-center gap-16 lg:mt-0 lg:grid-cols-[1.1fr_0.9fr]'>
				...
				<motion.div
					...
					<motion.div
						...
						<span className='bg-primary-400 h-2.5 w-2.5 animate-pulse rounded-full' />
						Workspace setup
					</motion.div>

					<motion.h1
						variants={itemVariants}
						className='via-primary-950 to-primary-900 max-w-3xl bg-gradient-to-r from-slate-900 bg-clip-text text-5xl leading-[0.95] font-black tracking-tight text-transparent md:text-7xl xl:text-[76px] dark:from-white dark:via-zinc-200 dark:to-zinc-100'>
					...
					<motion.div
						...
						{workspaceStats.map((stat) => (
							<motion.div
								...
								className='group cursor-default rounded-3xl border border-white/60 bg-white/60 p-5 shadow-[0_8px_30px_rgb(0,0,0,0.015)] backdrop-blur-md transition-all duration-300 hover:border-white hover:bg-white/85 dark:border-zinc-800/40 dark:bg-zinc-900/60 dark:hover:border-zinc-700 dark:hover:bg-zinc-900/85'>
								<p className='text-3xl font-black tracking-tight text-slate-900 dark:text-zinc-100'>
									{stat.value}
								</p>
								<p className='mt-2 text-[9px] font-black tracking-widest text-slate-400 uppercase dark:text-zinc-500'>
									{stat.label}
								</p>
							</motion.div>
						))}
				...
				<motion.div
					...
					<div className='from-primary-400 to-primary-400 absolute -top-12 -right-10 -z-10 hidden h-32 w-32 rounded-[2.5rem] bg-gradient-to-tr opacity-20 blur-2xl lg:block' />
					...
					<div className='relative rounded-[2.5rem] border border-white/50 bg-white/80 p-8 text-slate-950 shadow-[0_25px_60px_rgba(8,_112,_184,_0.05)] backdrop-blur-xl dark:border-zinc-800/50 dark:bg-zinc-900/80 dark:text-zinc-50 dark:shadow-[0_25px_60px_rgba(0,0,0,0.2)]'>
						...
						<div className='mb-8 flex items-center justify-between'>
							...
							<div className='border-primary-100/35 bg-primary-50 text-primary-600 dark:border-primary-900/30 dark:bg-primary-950/40 dark:text-primary-400 flex h-12 w-12 items-center justify-center rounded-2xl border shadow-sm'>
						...
						<form className='space-y-6' onSubmit={formik.handleSubmit}>
							...
							<div className='space-y-2'>
								...
								<div className='group relative flex items-center'>
									<Building2 className='group-focus-within:text-primary-600 dark:group-focus-within:text-primary-400 absolute left-4 h-4.5 w-4.5 text-slate-400 transition-colors duration-200' />
									<input
										id='name'
										name='name'
										...
										className='focus:border-primary-500/80 focus:ring-primary-500/10 dark:focus:border-primary-500 dark:focus:ring-primary-500/15 block h-12 w-full rounded-2xl border border-slate-200 bg-white/55 pr-4 pl-12 text-sm font-semibold text-slate-900 shadow-xs transition-all duration-200 outline-none placeholder:text-slate-400 focus:bg-white focus:ring-4 dark:border-zinc-800 dark:bg-zinc-950/40 dark:text-zinc-100 dark:placeholder:text-zinc-600 dark:focus:bg-zinc-950/60'
									/>
								</div>
							</div>
							...
							<div className='space-y-2'>
								...
								<div className='focus-within:border-primary-500/80 focus-within:ring-primary-500/10 focus-within:dark:border-primary-500/80 focus-within:dark:ring-primary-500/15 flex h-12 items-center overflow-hidden rounded-2xl border border-slate-200 bg-white/55 shadow-xs transition-all duration-200 focus-within:bg-white focus-within:ring-4 dark:border-zinc-800 dark:bg-zinc-950/40 focus-within:dark:bg-zinc-950/60'>
									<span className='flex h-full items-center border-r border-slate-100 bg-slate-50/50 px-4 text-xs font-black text-slate-400 dark:border-zinc-800 dark:bg-zinc-900/50 dark:text-zinc-500'>
										agent1o1.app/
									</span>
									<input
										id='slug'
										...
										onBlur={formik.handleBlur}
										className='min-w-0 flex-1 border-none bg-transparent px-4 text-sm font-semibold text-slate-900 outline-none placeholder:text-slate-400 focus:ring-0 dark:text-zinc-100 dark:placeholder:text-zinc-600'
									/>
								</div>
							</div>
							...
							<motion.button
								...
								className='group from-primary-400 to-primary-400 text-primary-950 shadow-primary-500/10 hover:shadow-primary-500/20 flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r text-sm font-black shadow-lg transition-all duration-250 hover:shadow-xl disabled:pointer-events-none disabled:opacity-50'>
						...
						<div className='mt-8 border-t border-slate-100/45 pt-6 dark:border-zinc-800/40'>
							<p className='mb-4 text-center text-[9px] font-black tracking-widest text-slate-400 uppercase dark:text-zinc-500'>
								...
								{workflowCards.map((card) => {
									...
									return (
										<motion.div
											...
											className='group/item flex cursor-pointer flex-col items-center rounded-2xl border border-slate-200/50 bg-white/60 p-3.5 text-center shadow-[0_4px_12px_rgba(0,0,0,0.01)] transition-all duration-200 hover:bg-white hover:shadow-md dark:border-zinc-800/40 dark:bg-zinc-900/60 dark:hover:border-zinc-700 dark:hover:bg-zinc-800'>
											<div

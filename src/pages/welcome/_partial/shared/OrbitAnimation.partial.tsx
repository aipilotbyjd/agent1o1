...
const OrbitAnimation = ({
	...
	return (
		<div className='relative hidden min-h-[520px] flex-col items-center justify-center border-l border-slate-100 bg-slate-50/50 p-8 lg:flex dark:border-zinc-800/80 dark:bg-zinc-950/20'>
			...
			<div className='bg-primary-400/10 text-primary-600 dark:text-primary-400 absolute top-6 right-6 flex items-center gap-1.5 rounded-lg px-2.5 py-1 text-[10px] font-black tracking-wider uppercase'>
				<Sparkles className='h-3 w-3' />
				Live Preview
			</div>

			<div className='relative flex h-72 w-72 items-center justify-center'>
				<div className='bg-primary-400/10 dark:bg-primary-400/5 absolute h-40 w-40 animate-pulse rounded-full blur-2xl' />
				...
				{step === 2 ? (
					<>
						<motion.div
							...
							className='from-primary-400 to-primary-400 text-primary-950 relative z-10 flex h-24 w-24 flex-col items-center justify-center rounded-full bg-gradient-to-tr via-fuchsia-500 p-2'>

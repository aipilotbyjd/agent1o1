			...
			<div className='flex flex-col items-center justify-center py-6'>
				...
				<div
					...
					className={`group relative flex h-36 w-36 cursor-pointer items-center justify-center rounded-full transition-all duration-300 ${
						isDragging
							...
							: 'hover:ring-primary-400/50 dark:hover:ring-primary-400/30 ring-4 ring-slate-100 dark:ring-zinc-800'
					}`}>
					{uploadProgress !== null ? (
						...
						<div className='from-primary-400/20 dark:from-primary-950/40 flex h-full w-full flex-col items-center justify-center rounded-full bg-gradient-to-tr to-emerald-400/20 dark:to-emerald-950/40'>
							<span className='text-primary-950 dark:text-primary-300 text-3xl font-black tracking-tight'>
								{userInitials}
							</span>
							{/* Hover overlay */}
					...
					{uploadProgress === null && (
						<div
							className={`absolute right-1.5 bottom-1.5 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white shadow-md transition-transform duration-300 group-hover:scale-110 dark:border-zinc-900 ${
								avatarUrl
				...
				<div className='mt-5 text-center'>
					<p className='text-xs font-bold text-slate-700 dark:text-zinc-300'>
						...
						<span className='text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 underline'>
							browse files
						</span>
					</p>

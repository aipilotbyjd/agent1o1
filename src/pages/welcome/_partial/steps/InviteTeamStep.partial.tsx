				...
				<div className='space-y-5 pt-1'>
					...
					<div className='space-y-2'>
						<div className='flex items-center justify-between'>
							...
							{hasValidEmails && (
								<span className='bg-primary-100 text-primary-700 dark:bg-primary-950/50 dark:text-primary-400 rounded-full px-2.5 py-0.5 text-[9px] font-black uppercase'>
						...
						<textarea
							...
							className='focus:border-primary-500 focus:ring-primary-400/10 block w-full resize-none rounded-2xl border border-slate-200/80 bg-slate-50/50 px-4 py-3 text-sm font-medium text-slate-900 transition-all outline-none placeholder:text-slate-400 focus:bg-white focus:ring-4 dark:border-zinc-800/80 dark:bg-zinc-950/30 dark:text-zinc-100 dark:focus:bg-zinc-950'
						/>
								...
								return (
									<button
										...
										className={`flex flex-col rounded-2xl border p-3.5 px-4 text-left transition-all duration-300 ${
											isSelected
												? 'border-primary-500 bg-primary-400/5 ring-primary-500/20 ring-2'
										...
										<span
											className={`text-xs font-bold ${
												isSelected
													...
													: 'dark:text-zinc-150 text-slate-900'
											}`}>
											{r.label}
										</span>
										<span className='mt-0.5 text-[10px] leading-normal font-semibold text-slate-400 dark:text-zinc-500'>
											{r.description}
										</span>
									</button>
								);
					...
					<div className='space-y-2'>
						<label
							...
							<span className='ml-1 font-bold text-slate-400 dark:text-zinc-600'>
								(optional)
							</span>
						</label>
						<textarea

...
/** Mirrors `StoreSkillScriptRequest`/`UpdateSkillScriptRequest`'s `language` enum. */
export const SKILL_SCRIPT_LANGUAGES = ['javascript', 'typescript', 'python', 'bash'] as const;

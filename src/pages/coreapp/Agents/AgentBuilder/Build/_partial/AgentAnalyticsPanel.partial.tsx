 ...
 * Derived client-side from the agent's runs: this backend has no per-agent
 * analytics endpoint. Runs record credits rather than tokens.
 */
				...
				<div className='rounded-xl border border-zinc-100 bg-zinc-50/20 p-3 dark:border-zinc-800 dark:bg-zinc-950/20'>
					...
					<div className='mt-3 flex h-24 items-end gap-1'>
						{by_day.map((d) => (
							<div
								key={d.day}
								title={`${d.day}: ${d.runs} runs, ${d.tokens} credits, ${d.failed} failed`}

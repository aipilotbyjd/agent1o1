					...
					{isSuccess ? (
						<div className='grid gap-y-5 text-center'>
							...
							<Link to={pages.pagesExamples.login.to}>
								<button
									type='button'
									className='flex w-full cursor-pointer items-center justify-center gap-1.5 rounded-xl bg-primary-600 py-3.5 text-xs font-bold tracking-wider text-zinc-900 uppercase shadow-md shadow-primary-600/25 transition-all hover:bg-primary-700'>
									SIGN IN NOW ›
								</button>
							</Link>
						</div>
						...
						<>
							...
							<form className='mt-5 grid gap-y-3.5' onSubmit={formik.handleSubmit}>
								...
								<button
									...
									className='mt-3 flex w-full cursor-pointer items-center justify-center gap-1.5 rounded-xl bg-primary-600 py-3.5 text-xs font-bold tracking-wider text-zinc-900 uppercase shadow-md shadow-primary-600/25 transition-all hover:bg-primary-700 active:bg-primary-800 disabled:pointer-events-none disabled:opacity-50'>

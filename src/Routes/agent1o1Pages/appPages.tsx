...
const KnowledgeLayout = lazy(() => import('@/pages/app/Knowledge/_layouts/Knowledge.layout'));
const KnowledgeListPage = lazy(() => import('@/pages/app/Knowledge/KnowledgeList.page'));

const TriggersLayout = lazy(() => import('@/pages/app/Triggers/_layouts/Triggers.layout'));
const TriggersListPage = lazy(() => import('@/pages/app/Triggers/TriggersList.page'));
...
const AppPages = [
	...
	{
		path: pages.app.subPages.knowledge.to,
	...
	{
		path: pages.app.subPages.triggers.to,
